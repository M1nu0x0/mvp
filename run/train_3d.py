        ...
        for thr in inference_conf_thr:
            ...
            if is_main_process():
                ...
                if 'panoptic' in config.DATASET.TEST_DATASET \
                    ...
                    logger.info(f'150mm FULL AP: {aps[-1]}')
                    logger.info(f'150mm FULL Recall: {recs[-1]}')
                    logger.info(f'150mm FULL recall@500mm: {recall500}')
                    logger.info(f'FULL MPJPE: {mpjpe}mm')
